<?php
    ...
    if(!isset($_SESSION['username'])){
        ...
        // 로그인한 유저의 user_id를 확인하는 함수
        $validateUserId = function ($username) use($conn){
        ...
        $user_id = $validateUserId($_SESSION['username']);

        $sql = "INSERT INTO topics(user_id , title , description , created_at) 
        VALUES('{$user_id}' , '{$filtered['title']}' , '{$filtered['description']}' , NOW())";
